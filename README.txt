...
the buttons.  Coop Panel Door Insert - Part 2.stl is printed using two colors.  I printed the lettering in white as you
...
excuse the cobwebs and mess.  You will probably notice three holes drilled into control panel door.  Those are from my previous
setup which was using a Raspberry Pi 3B.  I plan on 3d printing a couple of wooden inserts to plug those holes.
